 ...
 */
public class ExternalOnSubscribe implements Observable.OnSubscribe<Cursor> {

    private String[] GALLERY_PROJECTION;

    private final CursorLoader externalLoader;

    public ExternalOnSubscribe(CursorLoader internalLoader, String[] GALLERY_PROJECTION) {
