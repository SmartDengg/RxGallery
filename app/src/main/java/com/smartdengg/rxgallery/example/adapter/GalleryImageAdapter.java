...
public class GalleryImageAdapter extends RecyclerView.Adapter<GalleryImageAdapter.ViewHolder>
  ...
  public GalleryImageAdapter(Context context) {
    ...
    this.selectedDrawable = context.getResources().getDrawable(R.drawable.iv_boundary_shape);
  }
  ...
  private void bindValue(ViewHolder holder, final int position, ImageEntity entity) {
    ...
    RxDebounceClick.onClick(holder.thumbIv).forEach(new Action1<Void>() {
  ...
  private void runEnterAnimation(View itemView, int position) {
    ...
    if (position > lastAnimatedPosition) {
      ...
      ViewCompat.animate(itemView)
          ...
          .setDuration(context.getResources().getInteger(android.R.integer.config_longAnimTime))
          .withLayer()
