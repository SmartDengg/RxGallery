...
import com.smartdengg.rxgallery.example.utils.DensityUtil;
...
public class BottomAutoBehavior extends CoordinatorLayout.Behavior<RelativeLayout> {
  ...
  @Override
  public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, RelativeLayout child,
      View directTargetChild, View target, int nestedScrollAxes) {
    return (nestedScrollAxes & ViewCompat.SCROLL_AXIS_VERTICAL) != 0;
  }

  @Override public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, RelativeLayout child,
  ...
  private void hideView(final View view) {
    ...
    BottomAutoBehavior.this.runTranslateAnimation(view, translateY,
