...
public class GalleryImageAdapter extends RecyclerView.Adapter<GalleryImageAdapter.ViewHolder>
    implements Observer<List<ImageEntity>> {
  ...
  @Override public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.gallery_image_item, parent, false));
  }
  ...
  @Override public void onNext(List<ImageEntity> galleryFolderEntities) {
  ...
  public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    @NonNull @Bind(R.id.gallery_image_item_root_view) protected FrameLayout rootView;
    ...
    @NonNull @OnClick(R.id.gallery_image_item_thumb_iv) protected void onItemClick() {
