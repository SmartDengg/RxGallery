 ...
 */
public class GalleryFolderAdapter extends RecyclerView.Adapter<GalleryFolderAdapter.ViewHolder> implements Observer<List<FolderEntity>> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @NonNull
        @Bind(R.id.gallery_folder_item_name_tv)
        protected TextView nameTv;
        @NonNull
        @Bind(R.id.gallery_folder_item_count_tv)
        protected TextView countTv;
        @NonNull
        @Bind(R.id.gallery_folder_item_flag_iv)
