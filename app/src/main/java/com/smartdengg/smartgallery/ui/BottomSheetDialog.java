package com.smartdengg.smartgallery.ui;
...
public class BottomSheetDialog extends AppCompatDialog {
  ...
  private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
    ...
    final CoordinatorLayout coordinator =
        (CoordinatorLayout) LayoutInflater.from(getContext()).inflate(R.layout.bottom_sheet_layout, null);
  ...
  private boolean shouldWindowCloseOnTouchOutside() {
    ...
    return getContext().getTheme().resolveAttribute(android.R.attr.windowCloseOnTouchOutside, value, true)
        && value.data != 0;
  }
}
